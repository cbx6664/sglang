...
def setup_environment(server_args) -> None:
    ...
    os.environ["LOG_DIR"] = f"/home/bingxche/log/{model_name}_ep4_mixtral_dataset_{CONFIG['num_samples']}_prompts_8_experts_eplb"
    
    # whether to log expert allocation, token distribution info...
    os.environ["RECORD_EXPERT_ALLOCATION"] = "True"
    os.environ["RECORD_TOKEN_DISTRIBUTION"] = "True"
...
CONFIG = {
    ...
    "num_samples": 20,  # number of rows of dataset to use for inference
...
def save_outputs_to_json(outputs: Any) -> None:
    ...
    path = os.path.join(output_dir, "outputs.json")
